...
/// 移动Android端标识符的字符串长度
#define XTP_IMEI_LEN 16
/// 移动ios端标识符的字符串长度
#define XTP_IDFV_LEN 37
/// 其他移动端标识符的字符串长度
#define XTP_GUID_LEN 40
/// 手机号码的字符串长度
#define XTP_TEL_LEN 12
...
typedef enum XTP_TBT_TYPE {
	...
	XTP_TBT_STATE = 3,      ///<逐笔状态订单，2.2.32版本新增字段
}XTP_TBT_TYPE;
...
enum XTPTerminalType
{
	...
	XTP_TERMINAL_WP,                ///<"MW",Mobile-Windows Phone及其他移动终端
