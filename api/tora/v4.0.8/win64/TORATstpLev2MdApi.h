...
namespace TORALEV2API
{
	...
	public:
		...
		///订阅IOPV独立行情应答
		virtual void OnRspSubIOPV(CTORATstpSpecificSecurityField* pSpecificSecurity, CTORATstpRspInfoField* pRspInfo, int nRequestID, bool bIsLast) {};

		///取消订阅IOPV独立行情应答
		virtual void OnRspUnSubIOPV(CTORATstpSpecificSecurityField* pSpecificSecurity, CTORATstpRspInfoField* pRspInfo, int nRequestID, bool bIsLast) {};
		...
		//IOPV独立行情通知
		virtual void OnRtnIOPV(CTORATstpLev2IOPVField* pIOPV) {};
	...
	public:
		...
		///@param nCount 要订阅/退订行情的合约个数
		///@remark 
		virtual int SubscribeIOPV(char* ppSecurityID[], int nCount, TTORATstpExchangeIDType ExchageID) = 0;

		///退订IOPV独立行情
		///@param ppSecurityID 合约ID  
		///@param nCount 要订阅/退订行情的合约个数
		///@remark 
		virtual int UnSubscribeIOPV(char* ppSecurityID[], int nCount, TTORATstpExchangeIDType ExchageID) = 0;
