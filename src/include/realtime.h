...
public:
    virtual trader_api &get_trader()
    {
        return *_trader;
    }

    virtual market_api &get_market()
    {
        return *_market;
    }
    ...
    orderref_t insert_order(eOrderFlag order_flag, const std::string &contract, eDirOffset dir_offset, double price,
                            int volume);
