...
strategy::strategy(stratid_t id, frame &frame) :
    _id(id), _frame(frame)
{}
...
{
    SPDLOG_DEBUG("buy_open({}, {}, {})", contract, price, volume);
...
{
    SPDLOG_DEBUG("sell_open({}, {}, {})", contract, price, volume);
...
{
    SPDLOG_DEBUG("buy_close({}, {}, {})", contract, price, volume);
...
{
    SPDLOG_DEBUG("sell_close({}, {}, {})", contract, price, volume);
...
{
    SPDLOG_DEBUG("buy_close_today({}, {}, {})", contract, price, volume);
...
{
    SPDLOG_DEBUG("sell_close_today({}, {}, {})", contract, price, volume);
...
{
    SPDLOG_DEBUG("cancel_order({})", order_ref);
